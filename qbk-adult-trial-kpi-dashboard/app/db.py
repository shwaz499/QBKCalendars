...
CREATE TABLE IF NOT EXISTS adult_kpi_dashboard_cache (
    cache_key TEXT PRIMARY KEY,
    payload_json TEXT NOT NULL,
    updated_at TEXT NOT NULL
);

CREATE TABLE IF NOT EXISTS daysmart_admin_checkin_cache (
...
CREATE TABLE IF NOT EXISTS daysmart_live_registration_cache (
    customer_id INTEGER PRIMARY KEY,
    registrations_json TEXT NOT NULL,
    updated_at TEXT NOT NULL
);

CREATE TABLE IF NOT EXISTS daysmart_pack_cache (
    customer_id INTEGER PRIMARY KEY,
    pack_name TEXT,
    updated_at TEXT NOT NULL
);
